...
@section('main')
    <main id="main" class="main">
        ...
        <div class="filter row mb-3">
            ...
            <div class="col-3">
                <a href="{{url('admin/performance_shop/all')}}" class="btn btn-success">Làm mới</a>
            </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Doanh thu tháng này:  <span id="total-revenue" style="color: red;font-size: 18px;font-weight: 500;margin-left: 10px">{{number_format($currentRevenue)}} VND</span></h5>
