<div class="modal fade" id="addtoCartModel" tabindex="-1" aria-labelledby="addtoCartModelLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addtoCartModelLabel">Thêm vào Giỏ hàng</h5>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-8 product-content">
                                ...
                                <p class="product-price">Đơn giá: <span style="font-weight: 600;">{{ number_format($product->price, 0, ',', '.') }} VNĐ</span>
                                </p>
                                <p class="product-price">Số lượng còn lại: <span
                                        style="font-weight: 600;">{{ number_format($product->quantity, 0, ',', '.') }}</span>
                                </p>
                            </div>
                        </div>
                        @php
                        ...
                        <div class="buyer-info">
                            ...
                            <div class="buyer-form">
                                <div class="input-detail">
                                    ...
                                    <input type="text" class="input-field" name="full_name"
                                ...
                                <div class="input-detail">
                                    ...
                                    <input type="text" class="input-field" name="phone" value="{{ $user->phone ?? '' }}"
                                           readonly/>
                                </div>
                            </div>
                            <div class="buy-for">
                            ...
                            <div class="buy-note">
                                <div class="input-detail">
                                    ...
                                    <textarea rows="5" placeholder="Nhập tin nhắn của bạn muốn gửi đến người nhận ở đây"
                                              name="note" class="input-field">{{ old('note') }}</textarea>
                                </div>
                            </div>
                            <div class="buy-for-me-quantity">
                                <div class="input-detail">
                                    <label for="quantity" class="label-field">Nhập số lượng</label>
                                    <input type="number" class="input-field for-me-quantity" name="quantity"
                                           id="receiver-number" value="{{ old('quantity') }}" min="0"
                        ...
                        <div class="receiver-info">
                            <div class="receiver-header">
                                ...
                                <div class="excel-upload">
                                    ...
                                    <div class="tooltip-text">Vui lòng upload file excel với 2 cột: Số điện thoại và Số
                                        lượng
                                    </div>
                                </div>
                            </div>
                            <div class="example-excel">
                                <button class="download-link" type="button"
                            ...
                            <div class="receiver-detail">
                                <div class="d-flex justify-content-between align-items-center mb-3 wrap-mobile">
                                    ...
                                    <div class="add-receiver-btn">
                                        <img src="{{ asset('assets/images/plus-icon.png') }}" alt="Plus icon"
                                             class="plus-icon"/>
                                    ...
                                    @for ($index = 0; $index < $receiverCount; $index++)
                                        <div class="receiver-item" data-index="{{ $index }}">
                                            ...
                                            <input type="text" placeholder="0123456789"
                                                   name="receivers[{{ $index }}][phone]" class="receiver-phone"
                                                   value="{{ old("receivers.$index.phone") }}">
                                            <input type="number" name="receivers[{{ $index }}][quantity]"
                                                   class="receiver-number receiver-quantity"
                                                   value="{{ old("receivers.$index.quantity", 1) }}">
                                            <img src="{{ asset('assets/images/trash-icon.png') }}" alt="trash icon"
                                                 class="trash-icon">
                                        </div>
                                    @endfor
                                </div>
